...
class MediaManager {
    ...
    handleMediaUpdate(data, reason = 'update') {
        ...
        const hasInternalSourceId = Object.prototype.hasOwnProperty.call(incoming, '_source_id');
        const hasSourceId = Object.prototype.hasOwnProperty.call(incoming, 'source_id');

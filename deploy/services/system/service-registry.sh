...
SERVICE_DESC["beo-player-mass.service"]="Music Assistant Player (Port 8781)"
SERVICE_DESC["beo-librespot.service"]="go-librespot (Spotify Connect)"
SERVICE_DESC["beo-hlk.service"]="Local HLK Sensor (Port 8784)"
...
OPTIONAL_SOURCES=(
    ...
    "KODI|beo-source-kodi.service|🎬|Kodi source"
    "MUSIC|beo-source-mass.service|🎵|Music Assistant source"
)
